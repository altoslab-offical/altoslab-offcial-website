...
const language = "fil" as const;
const title = "AI Lab Notes | ALTOS LAB Journal";
const description = "ALTOS LAB journal tungkol sa AI products, agents, automation, search visibility, case studies, at market signals.";
...
export default async function FilipinoBlogIndexPage({ searchParams }: PageProps) {

...
const description = "Jurnal ALTOS LAB tentang produk AI, agent, automasi, keterlihatan carian, kajian kes dan isyarat pasaran.";
...
export default async function MalayBlogIndexPage({ searchParams }: PageProps) {

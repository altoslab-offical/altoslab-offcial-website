...
BUCKET="${GCS_BUCKET:-altoslab-official-cms}"
...
env_vars=(
  ...
  "ALTOS_BLOG_COLUMN_DAILY_LIMIT=${ALTOS_BLOG_COLUMN_DAILY_LIMIT:-1}"
  "ALTOS_BLOG_COLUMN_SLOTS=${ALTOS_BLOG_COLUMN_SLOTS:-morning}"

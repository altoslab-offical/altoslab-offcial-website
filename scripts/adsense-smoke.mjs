...
const editorialPolicyPage = read("app/editorial-policy/page.tsx");
...
assert(homepageRoute.includes("altos-trust-links") && homepageRoute.includes("/privacy"), "homepage route exposes trust and policy links");
assert(siteFooter.includes("/about") && siteFooter.includes("/contact"), "site footer links to accountable owner and contact pages");
assert(siteFooter.includes("/editorial-policy") && siteFooter.includes("/privacy") && siteFooter.includes("/terms"), "site footer links to editorial, privacy and terms pages");
assert(sitemap.includes('"/about"') && sitemap.includes('"/contact"'), "sitemap includes about and contact trust pages");
assert(sitemap.includes('"/editorial-policy"') && sitemap.includes('"/privacy"') && sitemap.includes('"/terms"'), "sitemap includes policy trust pages");
assert(aboutPage.includes("What we do") && aboutPage.includes("Why the journal exists"), "about page explains ownership and site purpose");
assert(contactPage.includes("hello@altoslab.ai") && contactPage.includes("Editorial corrections"), "contact page supports business and correction requests");
assert(editorialPolicyPage.includes("Original value requirement") && editorialPolicyPage.includes("Automation and human review"), "editorial policy states originality and review standards");
assert(privacyPage.includes("Google advertising cookies") && privacyPage.includes("Google Ads Settings"), "privacy page includes Google advertising cookie disclosure");
assert(termsPage.includes("Content and attribution") && termsPage.includes("External links"), "terms page covers content attribution and external links");

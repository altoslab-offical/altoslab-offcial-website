...
function inlineTextHtml(value) {
  ...
  html = html.replace(/`([^`\n]+)`/g, "<code>$1</code>");
  html = html.replace(/==([^=\n]+)==/g, '<mark class="rich-highlight">$1</mark>');
  html = html.replace(/\*\*([^*\n][\s\S]*?[^*\n])\*\*/g, "<strong>$1</strong>");
...
const ARTICLE_DESIGNER_CSS = `
.blog-article-page{padding-top:28px}.blog-article-page article{max-width:820px;margin-inline:auto}.blog-article-page .article-hero{width:min(820px,100%);margin-inline:0 auto;text-align:left}.blog-article-page .article-nav-row{margin-bottom:22px}.blog-article-page .article-hero h1{margin:0;font-size:clamp(34px,3.25vw,44px);line-height:1.1;letter-spacing:0;text-align:left}.blog-article-page .article-meta{justify-content:flex-start;margin-top:14px}.blog-article-page .hero-copy{margin-top:18px;font-size:18px;line-height:1.45;text-align:left}.blog-article-page .article-cover{margin-top:28px}.blog-article-page .geo-summary{border-left:4px solid #c8ff00;background:linear-gradient(90deg,rgb(200 255 0 / .14),rgb(200 255 0 / .04));color:#050603}.blog-article-page .geo-summary strong{color:#050603;font-weight:850}.blog-article-page .article-takeaways{color:#050603}.blog-article-page .article-takeaways .eyebrow{color:#050603;font-weight:850}.blog-article-page .article-takeaways ul{color:#050603}.blog-article-page .article-takeaways li{width:fit-content;max-width:100%;color:#050603;font-weight:850;line-height:1.55;background:linear-gradient(to top,rgb(200 255 0 / .68) 0 .42em,transparent .42em);box-decoration-break:clone;-webkit-box-decoration-break:clone}.blog-article-page .article-takeaways li::marker{color:#c8ff00}.blog-article-page .rich-text blockquote{margin:2em 0;padding:18px 20px;border-left:4px solid #050603;background:linear-gradient(90deg,rgb(200 255 0 / .16),rgb(200 255 0 / .04) 62%,transparent);color:#050603}.blog-article-page .rich-text blockquote p{margin:0}.blog-article-page .rich-text strong,.blog-article-page .rich-highlight{color:#050603;font-weight:850;background:linear-gradient(to top,rgb(200 255 0 / .72) 0 .42em,transparent .42em);box-decoration-break:clone;-webkit-box-decoration-break:clone;border-radius:2px;padding:0 .04em}.blog-article-page .rich-highlight{background:linear-gradient(to top,rgb(200 255 0 / .78) 0 .42em,transparent .42em)}@media(max-width:760px){.blog-article-page{padding-top:28px}.blog-article-page .article-hero h1{font-size:clamp(28px,8vw,38px)}}
`;
...
<head>
  ...
  <style>${CSS}${ARTICLE_DESIGNER_CSS}</style>
</head>
<body>
${analyticsBody(env)}
<div class="site-home blog-site-shell">
